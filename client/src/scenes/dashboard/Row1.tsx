    ...
    return (
        <>    
            <DashboardBox gridArea="a">
                <BoxHeader title="Revenue and Expenses" sideText="+10%"/>
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    <Tooltip />
                    <Area type="monotone" dataKey="revenue" dot={true} stroke={palette.primary.main} fill="url(#colorRevenue)" />
                    <Area type="monotone" dataKey="expenses" dot={true} stroke={palette.primary.main} fill="url(#colorExpenses)" />
                    </AreaChart>
                </ResponsiveContainer>
            </DashboardBox>
            ...
            <BoxHeader title='Revenue Monthly' sideText='+5%'/>
            <ResponsiveContainer width="100%" height="100%">
                <BarChart
                width={500}
                height={300}
